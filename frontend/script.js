...
// API base URL: set window.__API_BASE_URL__ via frontend/config.js (generated by Netlify build from env var API_BASE_URL).
const API_BASE_URL =
  (typeof window !== "undefined" && window.__API_BASE_URL__) ||
  "https://deepfake-ai-gp3d.onrender.com";
